function incarca() {
    ...
    document.getElementById('data-vinri').innerHTML = localStorage.getItem('data-vineri');
    document.getElementById('data-sambata').innerHTML = localStorage.getItem('data-sambata');
    document.getElementById('data-duminica').innerHTML = localStorage.getItem('data-dumnica');
}
